...
def YouBot(Tse_post,new_config,Kp,Ki,jointlimit):
    ...
    # Overwrite
    f = open("C:/Users/10448/Desktop/Lin_Zhisheng/code/python type file/YouBot.csv", "w") 
    # give y Tse_post
    y = new_config_arr
    ...
    # Open a file for output
    # Overwrite
    f = open("C:/Users/10448/Desktop/Lin_Zhisheng/code/python type file/X_err.csv", "w") 
    # give y Tse_post
    z = X_err_arr
    # For loop running to print each csv row
    ...
    # here we plot
    # load X_err.csv
    X = np.array(np.genfromtxt('C:/Users/10448/Desktop/Lin_Zhisheng/code/python type file/X_err.csv', delimiter=','))
